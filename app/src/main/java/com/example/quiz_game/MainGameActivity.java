...
public class MainGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
        tb = Typeface.createFromAsset(getAssets(), "fonts/TrilliumWeb-Bold.ttf");
        sb = Typeface.createFromAsset(getAssets(), "fonts/nontarnishable.ttf");
    ...
    public void gameLostPlayAgain() {
        ...
        int coin = coinValue - 1;
        String s = currentQuestion.getAnswer();

        String score = String.valueOf(coin);
        intent.putExtra("yourScore", score);
        intent.putExtra("CorrectAns", s);
    ...
    public void resetColor() {
        buttonA.setButtonColor(ContextCompat.getColor(getApplicationContext(),R.color.teal_700));
        buttonB.setButtonColor(ContextCompat.getColor(getApplicationContext(),R.color.teal_700));
        buttonC.setButtonColor(ContextCompat.getColor(getApplicationContext(),R.color.teal_700));
        buttonD.setButtonColor(ContextCompat.getColor(getApplicationContext(),R.color.teal_700));
    }
